...
pub(in super::super) struct OverlayControllerState {
    ...
    pub(in super::super) keybinding_edit_input: Option<Entity<InputState>>,
    pub(in super::super) keybinding_edit_input_subscription: Option<Subscription>,
    pub(in super::super) keybinding_edit_input_needs_focus: bool,
