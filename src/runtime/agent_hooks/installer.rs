...
use yttt_agent_omp::OMP_EXTENSION_SOURCE;
...
const PI_EXTENSION_SOURCE: &str = r#"const PREFIX = "yttt-agent-v1:";
const MAX_TEXT = 2048;
...
const OPENCODE_PLUGIN_SOURCE: &str = r#"const endpoint = process.env.YTTT_AGENT_HOOK_ENDPOINT;
