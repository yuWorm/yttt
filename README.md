...
[Downloads / 下载](https://github.com/yuWorm/yttt/releases/tag/v0.3.0) ·
[Release notes / 双语更新日志](CHANGELOG.md#030---2026-09-16) ·
[Changes since the last public release / 与上一公开版对比](https://github.com/yuWorm/yttt/compare/v1.0.0...v0.3.0)
...
> **版本说明 / Versioning:** 开发分支在已发布的 v1.0.0 之后回到了 pre-1.0 路线，0.3.0 是新版本。
> 旧版 1.0.0 用户请手动下载安装；按 SemVer 比较的更新检查不会将 0.3.0 视为升级。
> Development returned to pre-1.0 versioning after the public v1.0.0 release. Version 0.3.0 is newer
...
| --- | --- |
| macOS Apple Silicon | `yttt-0.3.0-macos-aarch64.dmg` |
| Windows x86_64 | `yttt-0.3.0-windows-x86_64-setup.exe` |
